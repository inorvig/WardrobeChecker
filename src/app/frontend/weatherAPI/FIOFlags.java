...
public class FIOFlags {
	...
	private void init(ForecastIO fio) {
		...
		if (fio.hasFlags()) {
			if (fio.getFlags().names().contains("darksky-unavailable"))
				this.flags.put("darksky-unavailable", toStringArray(fio
						.getFlags().get("darksky-unavailable").asArray()));

			if (fio.getFlags().names().contains("darksky-stations"))
				this.flags.put("darksky-stations", toStringArray(fio.getFlags()
						.get("darksky-stations").asArray()));

			if (fio.getFlags().names().contains("datapoint-stations"))
				this.flags.put("datapoint-stations", toStringArray(fio
						.getFlags().get("datapoint-stations").asArray()));

			if (fio.getFlags().names().contains("isd-stations"))
				this.flags.put("isd-stations", toStringArray(fio.getFlags()
						.get("isd-stations").asArray()));

			if (fio.getFlags().names().contains("lamp-stations"))
				this.flags.put("lamp-stations", toStringArray(fio.getFlags()
						.get("lamp-stations").asArray()));

			if (fio.getFlags().names().contains("metar-stations"))
				this.flags.put("metar-stations", toStringArray(fio.getFlags()
						.get("metar-stations").asArray()));

			// TODO metno-licenses

			if (fio.getFlags().names().contains("sources"))
				this.flags.put("sources",
						toStringArray(fio.getFlags().get("sources").asArray()));
	...
	/**
	 * Returns an array with the available flags in the report. If the array's
	 * lenght is 0, there are none. For more information refer to the API Docs:
	...
	/**
	 * Returns an array with the unavailable darksky stations For more
	...
	/**
	 * Returns an array with the available darksky stations For more information
	...
	/**
	 * Returns an array with the data point stations For more information refer
	 * to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return array with the stations
	...
	/**
	 * Returns an array with the isd stations For more information refer to the
	 * API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return array with the stations
	...
	/**
	 * Returns an array with the lamp stations For more information refer to the
	 * API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return array with the stations
	...
	/**
	 * Returns an array with the metar stations For more information refer to
	 * the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return array with the stations
	...
	/**
	 * Returns an array with the sources For more information refer to the API
	 * Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	...
	/**
	 * Returns a String with the units in use For more information refer to the
	 * API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
