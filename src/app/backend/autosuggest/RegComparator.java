...
public class RegComparator implements Comparator<String> {
	 ...
	 * @param bigram
	 */
	public RegComparator(String inputWord, String prevWord,
			HashMap<String, Integer> unigram, HashMap<String, Integer> bigram) {
	...
	public int compare(String word1, String word2) {
		...
		int alphabeticOrder = word2.compareTo(word1); // alphabetic order to
														// break ties

		if (word1.compareTo(inputWord) == 0) // if either string being compared
		...
		// split for bigram comparison and use the word just before given user
		// input
		if (word1.contains(" ")) {
			int i = word1.indexOf(" ");
