...
public class ForecastIO {
	...
	public ForecastIO(String LATITUDE, String LONGITUDE, String UNITS,
			String API_KEY) {
	...
	/**
	 * Sets the time for the request. Format should be passed as follows:<br>
	 ...
	 * [field1,field2,fieldN] with no spaces For more information refer to the
	 * API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @param excludeURL
	...
	/**
	 * Sets if the hourly report should be extended in the request. For more
	...
	/**
	 * Returns the timezone offset in an integer For more information refer to
	 * the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	...
	/**
	 * Returns the offset as a String with '+' or '-' sign. For more information
	...
	/**
	 * Sets the units to be passed in the request. If the units are unavailable,
	 * auto is setted.<br>
	 * Units can be setted with constants like ForecastIO.UNITS_AUTO. For more
	 * information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @param units
	...
	/**
	 * Does another query to the API and updates the data This only updates the
	 * data in ForecastIO class
	 * 
	 * @return True if successful
	 */
	public boolean update() {
		boolean b = getForecast(String.valueOf(getLatitude()),
				String.valueOf(getLongitude()));
		return b;
	}

	/**
	 * Gets the forecast reports for the given coordinates with the setted
	 * options
	 * 
	 * @param LATITUDE
	 * @param LONGITUDE
	...
	public boolean getForecast(String LATITUDE, String LONGITUDE) {
		...
		try {
			...
			System.err.println("Unable to connect to the API: "
					+ e.getMessage());
			return false;
		}
	...
	/*
	 * This change was suggested and made by github user brobzilla to add the
	 * ability to use an external http library. I found this to be a nice
	 * suggestion and improvement. However, because http libraries usually
	 * return the raw string response, I find that it would be useful to add a
	 * getForecast method that receives the response String as parameter.
	 */

	/**
	 * Parses the forecast reports for the given coordinates with the setted
	 * options Useful to use with an external http library
	 * 
	 * @param http_response
	 *            String
	 */
	...
	/**
	 * Parses the forecast reports for the given coordinates with the setted
	 * options Useful to use with an external http library Hint: The
	 * getForecast(String http_response) could be more useful since it receives
	...
	/**
	 * Returns the url that is created by internal UrlBuilder method. Useful to
	 * use with an external http library
	 * 
	 * @param LATITUDE
	 * @param LONGITUDE
	 * @return url string.
	...
	private String httpGET(String requestURL) {
		...
		try {
			...
			if (connection.getResponseCode() == 400) {
				System.out
						.println("Bad Responde. Maybe an invalid location was provided.\n");
				return null;
			} else {
