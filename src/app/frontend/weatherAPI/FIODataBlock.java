...
public class FIODataBlock {
	...
	private void update(JsonObject db) {
		...
		try {
			...
			if (db.get("data").isArray()) {
				...
				System.err
						.println("Not an array. Maybe you're trying to feed \"currently\" to a datablock.");
			}
	...
	/**
	 * Returns the summary for the given data block For more information refer
	 * to the API Docs: <a
	...
	/**
	 * Returns the icon for the given data block For more information refer to
	 * the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	...
	/**
	 * Returns a data point from the this data block For more information refer
	 * to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @param index
	...
	/**
	 * Returns the size of this data block which corresponds to the number of
	 * data points present
	 * 
