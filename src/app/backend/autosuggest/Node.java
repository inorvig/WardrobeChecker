...
public class Node {
	...
	private HashMap<Character, Node> children = new HashMap<Character, Node>(); // hashmap
																				// of
																				// node's
																				// children
																				// with
	 ...
	 *            : node's parent
	 * @param letter
	 *            : the letter to be stored in the node
	 * @param isLastLetter
	 *            : boolean indicating if the node marks the end of some word
	 */
	 ...
	 * 
	 * @param letter
	 *            : letter associated with child we are seeking
	 * @return Node that contains the letter inputted (node is a child of
	 *         current node)
	 */
	 ...
	 * 
	 * @param letter
	 *            : letter associated with child-to-be
	 * @param childNode
