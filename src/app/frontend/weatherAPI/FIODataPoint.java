...
public class FIODataPoint {
	...
	/**
	 * Returns a String with all the Forecast.io field's available in this data
	 * point.
	 * 
	...
	/**
	 * Returns a String array with all the Forecast.io fields available in this
	 * data point. It can be usefull to iterate over all available fields in a
	 * data point.
	 * 
	...
	/**
	 * Allows to set the timezone. If none is set, default is GMT.
	 * 
	 * @param tz
	 *            String with the timezone such as "GMT"
	 */
	 ...
	 * 
	 * @param key
	 *            name of the field in the data point
	...
	public String getByKey(String key) {
		...
		if (key.contains("Time")) {
			...
			out = dfm.format(Long.parseLong(String.valueOf(this.datapoint
					.get(key))) * 1000);
		} else
	...
	/**
	 * Returns the time at which this data point occurs. For more information
	 * refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return An human-readable time string formated as [dd-MM-yyyy HH:mm:ss].
	 *         Returns "no data" if the field is not defined.
	 */
	public String time() {
	...
	/**
	 * Returns a human-readable text summary of the data point. For more
	 * information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return String with the summary text. Returns "no data" if the field is
	 *         not defined.
	 */
	...
	/**
	 * Returns a machine-readable text summary of the data point, suitable for
	 * selecting an icon for display. For more information refer to the API
	 * Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return String with the icon text. Returns "no data" if the field is not
	 *         defined.
	 */
	public String icon() {
	...
	/**
	 * Returns the sunset time for the given day. For more information refer to
	 * the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return An human-readable time string formated as [HH:mm:ss]. Returns
	 *         "no data" if the field is not defined.
	 */
	public String sunriseTime() {
		if (this.datapoint.containsKey("sunriseTime")) {
			DateFormat dfm = new SimpleDateFormat("HH:mm:ss");
			dfm.setTimeZone(TimeZone.getTimeZone(timezone));
			String time = dfm.format(Long.parseLong(String
					.valueOf(this.datapoint.get("sunriseTime"))) * 1000);
			return time;
		} else
			return "no data";
	}
	...
	/**
	 * Returns the sunrise time for the given day. For more information refer to
	 * the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return An human-readable time string formated as [HH:mm:ss]. Returns
	...
	public String sunsetTime() {
		if (this.datapoint.containsKey("sunsetTime")) {
			...
			dfm.setTimeZone(TimeZone.getTimeZone(timezone));
			String time = dfm.format(Long.parseLong(String
					.valueOf(this.datapoint.get("sunsetTime"))) * 1000);
			return time;
		} else
			return "no data";
	}
	...
	/**
	 * A numerical value representing the average expected intensity. For more
	 * information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the precipitation intensity. Returns -1 if
	...
	/**
	 * A numerical values representing the maximum expected intensity of
	 * precipitation. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the maximum precipitation intensity. Returns
	 *         -1 if the field is not defined.
	 */
	...
	/**
	 * A numerical values representing the time at which the maximum expected
	 * intensity of precipitation occurs. For more information refer to the API
	 * Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return An human-readable time string formated as [HH:mm:ss] Returns
	...
	public String precipIntensityMaxTime() {
		if (this.datapoint.containsKey("precipIntensityMaxTime")) {
			...
			dfm.setTimeZone(TimeZone.getTimeZone(timezone));
			String time = dfm
					.format(Long.parseLong(String.valueOf(this.datapoint
							.get("precipIntensityMaxTime"))) * 1000);
			return time;
		} else
			return "no data";
	}
	 ...
	 * probability of precipitation occuring at the given time. For more
	 * information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the probabily. Returns -1 if the field is
	 *         not defined.
	 */
	 ...
	 * rain, snow, sleet or hail. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A string with the type of precipitation Returns "no data" if the
	 ...
	 * For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the expected value. Returns -1 if the field
	 *         is not defined.
	 */
	...
	/**
	 * The temperature at the given time using the units defined in the class
	 * ForecastIO. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the temperature. Returns null if the field
	 *         is not defined.
	 */
	...
	/**
	 * The temperature error at the given time using the units defined in the
	 * class ForecastIO. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the temperature. Returns null if the field
	 *         is not defined.
	...
	/**
	 * The minimum temperature expected for a given day the units defined in the
	 * class ForecastIO. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the minimum temperature. Returns null if the
	 *         field is not defined.
	 */
	 ...
	 * in the class ForecastIO. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the minimum temperature. Returns null if the
	 *         field is not defined.
	...
	/**
	 * The time at with the minimum temperature is expected to occur. For more
	 * information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return An human-readable time string formated as [HH:mm:ss] Returns
	...
	public String temperatureMinTime() {
		if (this.datapoint.containsKey("temperatureMinTime")) {
			...
			dfm.setTimeZone(TimeZone.getTimeZone(timezone));
			String time = dfm.format(Long.parseLong(String
					.valueOf(this.datapoint.get("temperatureMinTime"))) * 1000);
			return time;
		} else
			return "no data";
	}
	...
	/**
	 * The maximum temperature expected for a given day the units defined in the
	 * class ForecastIO. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the maximum temperature. Returns null if the
	 *         field is not defined.
	 */
	...
	/**
	 * The time at which the maximum temperature is expected to occur. For more
	 * information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return An human-readable time string formated as [HH:mm:ss] Returns
	...
	public String temperatureMaxTime() {
		if (this.datapoint.containsKey("temperatureMaxTime")) {
			...
			dfm.setTimeZone(TimeZone.getTimeZone(timezone));
			String time = dfm.format(Long.parseLong(String
					.valueOf(this.datapoint.get("temperatureMaxTime"))) * 1000);
			return time;
		} else
			return "no data";
	}
	...
	/**
	 * The apparent temperature at the given time using the units defined in the
	 * class ForecastIO. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the apparentTemperature. Returns null if the
	 *         field is not defined.
	 */
	...
	/**
	 * The minimum apparent temperature expected for a given day the units
	 * defined in the class ForecastIO. For more information refer to the API
	 * Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the minimum apparent temperature. Returns
	 *         null if the field is not defined.
	 */
	...
	public String apparentTemperatureMinTime() {
		if (this.datapoint.containsKey("temperatureMinTime")) {
			...
			String time = dfm
					.format(Long.parseLong(String.valueOf(this.datapoint
							.get("apparentTemperatureMinTime"))) * 1000);
			return time;
		} else
			return "no data";
	}
	...
	/**
	 * The maximum apparent temperature expected for a given day the units
	 * defined in the class ForecastIO. For more information refer to the API
	 * Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the apparent maximum temperature. Returns
	 *         null if the field is not defined.
	 */
	...
	public String apparentTemperatureMaxTime() {
		if (this.datapoint.containsKey("apparentTemperatureMaxTime")) {
			...
			String time = dfm
					.format(Long.parseLong(String.valueOf(this.datapoint
							.get("apparentTemperatureMaxTime"))) * 1000);
			return time;
		} else
			return "no data";
	}
	...
	/**
	 * The dew point for a given time with the units defined in the class
	 * ForecastIO. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the dew point. Returns -1 if the field is
	 *         not defined.
	 */
	...
	/**
	 * The dew point error for a given time with the units defined in the class
	 * ForecastIO. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the dew point. Returns -1 if the field is
	...
	/**
	 * The wind speed for a given time with the units defined in the class
	 * ForecastIO. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the wind speed. Returns -1 if the field is
	 *         not defined.
	 */
	...
	/**
	 * The wind speed error for a given time with the units defined in the class
	 * ForecastIO. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the wind speed. Returns -1 if the field is
	...
	/**
	 * The wind direction for a given time in degrees. For more information
	 * refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the wind direction. Returns -1 if the field
	 *         is not defined.
	 */
	...
	/**
	 * The wind direction error for a given time in degrees. For more
	 * information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the wind direction. Returns -1 if the field
	 ...
	 * of sky occluded by clouds. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the cloud cover. Returns -1 if the field is
	 *         not defined.
	 */
	...
	/**
	 * A numerical the percentage of sky occluded by clouds error. For more
	 * information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the cloud cover. Returns -1 if the field is
	...
	/**
	 * A numerical value representing the relative humidity error. For more
	 * information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the humidity. Returns -1 if the field is not
	 *         defined.
	 */
	 ...
	 * humidity. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the humidity. Returns -1 if the field is not
	 *         defined.
	...
	/**
	 * A numerical value with the sea level pressure with the units defined in
	 * the class ForecastIO. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the pressure. Returns -1 if the field is not
	 *         defined.
	 */
	...
	/**
	 * A numerical value with the sea level pressure error with the units
	 * defined in the class ForecastIO. For more information refer to the API
	 * Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	...
	/**
	 * A numerical value with the average visibility with the units defined in
	 * the class ForecastIO. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the visibility. Returns null if the field is
	 *         not defined.
	 */
	...
	/**
	 * A numerical value with the visibility error with the units defined in the
	 * class ForecastIO. For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the visibility. Returns null if the field is
	 ...
	 * ozone at the given time in Dobson units. For more information refer to
	 * the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the ozone. Returns -1 if the field is not
	 *         defined.
	 */
	public Double ozone() {
	...
	/**
	 * Nesrest Storm Bearing For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the ozone. Returns -1 if the field is not
	 *         defined.
	...
	/**
	 * Nesrest Storm Distance For more information refer to the API Docs: <a
	 * href="https://developer.forecast.io">https://developer.forecast.io</a>
	 * 
	 * @return A Double number with the ozone. Returns -1 if the field is not
	 *         defined.
